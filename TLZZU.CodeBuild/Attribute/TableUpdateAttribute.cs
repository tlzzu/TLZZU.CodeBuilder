...
namespace TLZZU.CodeBuild.Attribute
{
    ...
    public class TableUpdateAttribute:BaseAttribute,IReleaseMaker
    {
        ...
        public TableUpdateAttribute(string methodName,string updateFields, string whereSql, string description)
        {
